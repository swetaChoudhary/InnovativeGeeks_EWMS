<!--<html>
   ...
   <body>
    <?php /*
    include "con.php";
         $sql = "SELECT product_title,product_price, product_desc, product_image FROM products";
...
<html>
 ...
 <img src="product_images/<?php echo $row["product_image"]; ?>" class="img-responsive" /><br />
