...
<header class="header">
					...
					<div class="dropdown-menu" style="width:400px;">
						<div class="panel panel-success">
							...
							<div class="panel-body">
								...
								<div class="row">
								<div class="col-md-4" style="font-size:15px"><?php echo $i++; ?></div>
									<div class="col-md-4" style="font-size:15px"><img src="product_images/<?php  echo $row["image"];?>" height="80" width="60"></div>
									<div class="col-md-4" style="font-size:15px"><?php  echo $row["name"];?></div>
								</div>
                                <?php } ?>
							</div>
    ...
    <div class="header-2">
    <a href="profile.php" class="logo"><img src="logonew4.png" alt="" width="130px" height="30px" style="position:relative; top:25px; left:50px"> </a>
        <nav class="navbar">
            <a href="#home">home</a>
...
<section class="home" id="home">
    ...
    <div class="row">
        ...
        <div class="content">
            ...
            <a href="#" class="btn">Recycle Now</a>
        </div>
...
if(isset($_POST["add_to_cart"])){
  ...
  { */?>
 <!-- <a href="login_form.php"> Login First</a>-->
 <?php //} 
//} 
?>
<h1 class="heading" id="newpeoducts"> <span>New Arrivals</span> </h1>
<a href="products.php" style="margin-left:982px;font-size:18px">All Products >></a><br>

    <div class="box-container">
   
    <?php 
            $sql = "SELECT * FROM products ORDER BY Time DESC LIMIT 4;";
            $result = $mysqli->query($sql);
              while($row = $result->fetch_assoc()) { ?>
        ...
        <form method="post" action="cartItem.php">
            ...
            <div class="content">
                ...
                <div class="desc"><p><?php echo $row["product_desc"]; ?></p></div>
            </div>
            <div>
            ...
            <input type="hidden" name="hidden_desc" value="<?php echo $row["product_desc"]; ?>" />
            <input type="submit" name="add_to_cart" style="margin-top:-10px;" class="submit_btn" value="Add To Wishlist" />
			<input type="submit" name="contact_owner" style="margin-top:5px;" class="submit_btn" value="Contact Owner" />
		    </form>
            </div>
        </div>
        <?php 
