...
<header class="header">
	...
	<a href="index.php" class="logo"><img src="logonew4.png" alt="" width="130px" height="30px"> </a>
		...
		<ul class="nav navbar-nav navbar-right" style="display:flex;">
					...
					<div class="dropdown-menu" style="width:400px;">
						<div class="panel panel-success">
							<div class="panel-heading">
								<div class="row">
									<div class="col-md-3" style="font-size:15px">Sl.No</div>
									<div class="col-md-3" style="font-size:15px">Product Image</div>
									<div class="col-md-3" style="font-size:15px">Product Name</div>
									<div class="col-md-3" style="font-size:15px">Price in <?php echo CURRENCY; ?></div>
								</div>
							</div>
				...
				<li><a href="#" class="dropdown-toggle" data-toggle="dropdown" id="account"><span class="glyphicon glyphicon-user"></span> Login/Register</a>
